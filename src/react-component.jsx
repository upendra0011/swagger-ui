...
import SwaggerUIConstructor from "./core"
...
const SwaggerUI = ({
  ...
  // Custom props
  showAuthorization = config.defaults.showAuthorization,
  showTryItOut = config.defaults.showTryItOut,
  showInfoLinks = config.defaults.showInfoLinks,
  disableAccordion = config.defaults.disableAccordion,
  showOperationUtilities = config.defaults.showOperationUtilities,
  methodColors = config.defaults.methodColors,
}) => {
